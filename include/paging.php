			...
			###처음 버튼
				if ($c_page > $page_size) {
					...
					echo '<li class="paginate_button page-item">
                                <a href="'.$_SERVER["PHP_SELF"].'?pageNo='.$prev_list.'&'.$total_param.'" aria-controls="dataTable" data-dt-idx="1" tabindex="0" class="page-link">이전 페이지</a>
                            </li>';
			...
			###페이지 출력
				for ($i=$start_page;$i <= $end_page;$i++){
					...
					if($c_page != $page){
						...
						echo '<li class="paginate_button page-item">
                                <a href="'.$_SERVER["PHP_SELF"].'?pageNo='.$prev_list.'&'.$total_param.'" aria-controls="dataTable" data-dt-idx="1" tabindex="0" class="page-link">1</a>
                            </li>';
					}else{
						//echo "<span class='page'>".($i+1).'</span>';
						echo '<li class="paginate_button page-item activate">
                                <a href="'.$_SERVER["PHP_SELF"].'?pageNo='.$prev_list.'&'.$total_param.'" aria-controls="dataTable" data-dt-idx="1" tabindex="0" class="page-link">1</a>
                            </li>';
...
;					}
			...
			###다음버튼
				if($total_page > $end_page){
					...
					echo '<li class="paginate_button page-item">
                                <a href="'.$_SERVER["PHP_SELF"].'?pageNo='.$prev_list.'&'.$total_param.'" aria-controls="dataTable" data-dt-idx="1" tabindex="0" class="page-link">다음 페이지</a>
                            </li>';
